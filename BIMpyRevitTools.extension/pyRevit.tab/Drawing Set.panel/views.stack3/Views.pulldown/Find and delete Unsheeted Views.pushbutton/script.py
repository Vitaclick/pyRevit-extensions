...
count = len(unsheetedViews)
if count > 0:
    with revit.Transaction("deleting elemetns"):
        for i, vId in enumerate(unsheetedViews):
            out.update_progress(i + 1, count)
            try:
                revit.doc.Delete(vId)
